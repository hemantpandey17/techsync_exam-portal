    ...
    <script type="text/javascript">
        ...
        $(function(){
                window.setInterval(function() {
                    ...
                    if(updateTime == 0){
                        window.location = ("btech-submit.php?timer=1");
                    }
                }, 1000);
           ...
           if(isset($_POST['btn_btech']))
{
    ...
    $qry2="select * from answer_record where username='$user' and examname='B.TECH'";
    $res2=mysql_query($qry2);
    $numrow2=  mysql_num_rows($res2);
    $qry1="insert into answer_record (username,examname) values('$user','B.TECH')";
    $res1=  mysql_query($qry1);
    $qry="select * from questions_btech";
    $res=mysql_query($qry);
 ...
 if(isset($_POST['btn_submit']))
{
    ...
    $qry="select * from questions_btech";
   $var="answer".$i;
   $qry1="update answer_record set $var='$ans' where username='$user' and examname='B.TECH' ";
   $res1=mysql_query($qry1);
    $res=mysql_query($qry);
    $numrow=  mysql_num_rows($res);
    $data=array();
    ...
    if($ans===$correct && $i<=10)
    {
        ...
        $mark=$_SESSION['marks'];
        $qry3="update  answer_record set total='$mark' where username='$user' and examname='B.TECH'";
    ...
    $user=$_SESSION['user1'];
    $data6=array();
    $qry5="select * from answer_record where username='$user' and examname='B.TECH'";
    $qry6="select answer from questions_btech ";
