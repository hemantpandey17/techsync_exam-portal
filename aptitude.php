    ...
    <script type="text/javascript">
        ...
        $(function(){
                window.setInterval(function() {
                    ...
                    if(updateTime == 0){
                        window.location = ("apti-submit.php?timer=1");
                    }
                }, 1000);
           ...
           if(isset($_POST['btn_apti']))
{
    ...
    $qry2="select * from answer_record where username='$user' and examname='APTITUDE'";
    $res2=mysql_query($qry2);
    $numrow2=  mysql_num_rows($res2);
    $qry1="insert into answer_record (username,examname) values('$user','APTITUDE')";
    $res1=  mysql_query($qry1);
    $qry="select * from questions_apti";
    $res=mysql_query($qry);
 ...
 if(isset($_POST['btn_submit']))
{
    ...
    $qry="select * from questions_apti";
   $var="answer".$i;
   $qry1="update answer_record set $var='$ans' where username='$user' and examname='APTITUDE' ";
   $res1=mysql_query($qry1);
    $res=mysql_query($qry);
    $numrow=  mysql_num_rows($res);
    $data=array();
    ...
    if($ans===$correct && $i<=10)
    {
        ...
        $mark=$_SESSION['marks'];
        $qry3="update  answer_record set total='$mark' where username='$user' and examname='APTITUDE'";
    ...
    $user=$_SESSION['user1'];
    $data6=array();
    $qry5="select * from answer_record where username='$user' and examname='APTITUDE'";
    $qry6="select answer from questions_apti ";
