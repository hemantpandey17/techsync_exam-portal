    ...
    <script type="text/javascript">
        ...
        $(function(){
                window.setInterval(function() {
                    ...
                    if(updateTime == 0){
                        window.location = ("mba-submit.php?timer=1");
                    }
                }, 1000);
...
<div id="wrapper" style="border:1px solid white;height:1000">
	...
	<div id="page" style="height:800">
			...
			<div id="my-timer">
        You have  <b id="show-time"><?php $timer='4'; echo $timer; ?></b> seconds to answer this question      
</div>
           <?php 
           if(isset($_POST['btn_mba']))
{
    //session_start();
    //include "gate.php";
    $_SESSION['counter']=0;
    ...
    $qry2="select * from answer_record where username='$user' and examname='MBA'";
    $res2=mysql_query($qry2);
    $numrow2=  mysql_num_rows($res2);
    $qry1="insert into answer_record (username,examname) values('$user','MBA')";
    $res1=  mysql_query($qry1);
    $qry="select * from questions_mba";
    $res=mysql_query($qry);
 ...
 if(isset($_POST['btn_submit']))
{
    ...
    $qry="select * from questions_mba";
   $var="answer".$i;
   $qry1="update answer_record set $var='$ans' where username='$user' and examname='MBA' ";
   $res1=mysql_query($qry1);
    $res=mysql_query($qry);
    $numrow=  mysql_num_rows($res);
    $data=array();
    ...
    if($ans===$correct && $i<=10)
    {
        ...
        $mark=$_SESSION['marks'];
        $qry3="update  answer_record set total='$mark' where username='$user' and examname='MBA'";
    ...
    $user=$_SESSION['user1'];
    $data6=array();
    $qry5="select * from answer_record where username='$user' and examname='MBA'";
    $qry6="select answer from questions_mba ";
